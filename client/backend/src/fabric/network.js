...
const ccpPath = path.resolve("/Users/davey/Documents/github/fabric-samples", config.connectionProfile);
...
exports.createParticipant = async function (networkObj, id, bsn, name, role) {
    try {

        let response = await networkObj.contract.submitTransaction('createParticipant', id, bsn, name, role);
